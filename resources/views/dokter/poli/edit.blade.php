    ...
    <div class="py-12">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="p-4 sm:p-8 bg-white dark:bg-gray-800 shadow sm:rounded-lg">
                ...
                <form method="POST" action="{{ route('dokter.poli.update', $poli->id) }}">
                    @csrf
                    @method('PATCH')
                    ...
                    <div>
                        ...
                        <!-- Input untuk nama poli yang terisi dengan nama poli yang akan diedit -->
                        <x-text-input id="nama_poli" name="nama_poli" type="text" class="mt-1 block w-full"
