...
<head>
    ...
    <!-- Menyisipkan token CSRF untuk melindungi aplikasi dari serangan CSRF -->

    <title>{{ config('app.name', 'Laravel') }}</title>
    <!-- Menampilkan judul halaman, nama aplikasi Laravel atau nama yang telah dikonfigurasi -->

    <!-- Fonts -->
    <link rel="preconnect" href="https://fonts.bunny.net"> <!-- Menyiapkan koneksi awal untuk font -->
    <link href="https://fonts.bunny.net/css?family=figtree:400,500,600&display=swap" rel="stylesheet" />
    <!-- Menambahkan font Figtree untuk digunakan dalam halaman -->
    ...
    </script> <!-- Menambahkan jQuery dari CDN -->
    <script src="https://cdn.jsdelivr.net/npm/popper.js@1.14.3/dist/umd/popper.min.js"
        integrity="sha384-ZMP7rVo3mIykV+2+9J3UJ46jBk0WLaUAdn689aCwoqbBJiSnjAK/l8WvCWPIPm49" crossorigin="anonymous">
    </script> <!-- Menambahkan Popper.js dari CDN (digunakan oleh Bootstrap) -->
    <script src="https://cdn.jsdelivr.net/npm/bootstrap@4.1.3/dist/js/bootstrap.min.js"
        integrity="sha384-ChfqqxuZUCnJSK3+MXmPNIyE6ZbWh2IMqE241rYiqJxyMiZ6OW/JmZQ5stwEULTy" crossorigin="anonymous">
    </script> <!-- Menambahkan Bootstrap JS dari CDN -->
...
<body class="font-sans antialiased">
    <div class="min-h-screen bg-gray-100">
        <!-- Membuat tampilan halaman dengan background abu-abu dan tinggi minimal sepanjang layar -->
        @include('layouts.navigation') <!-- Menyertakan file layout navigasi (misalnya menu atas atau sidebar) -->

        <!-- Page Heading -->
        @isset($header)
            <!-- Jika variabel $header ada (terdefinisi), tampilkan bagian ini -->
            <header class="bg-white shadow"> <!-- Menambahkan background putih dengan bayangan -->
                <div class="max-w-7xl mx-auto py-6 px-4 sm:px-6 lg:px-8">
                    <!-- Membatasi lebar maksimum dan menambahkan padding -->
